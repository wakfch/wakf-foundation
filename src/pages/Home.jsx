...
const MADRETSCH_IMAGES = [
  { src: '/images/madretsch/madretsch-1.jpg', caption: 'Après rénovation' },
  { src: '/images/madretsch/madretsch-4.jpg', caption: 'Avant / Après' },
  { src: '/images/madretsch/madretsch-2.jpg', caption: 'Avant travaux' },
  { src: '/images/madretsch/madretsch-3.jpg', caption: 'Détail façade' },
];
